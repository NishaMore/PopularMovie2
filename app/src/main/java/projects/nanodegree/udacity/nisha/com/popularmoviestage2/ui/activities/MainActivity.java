...
import projects.nanodegree.udacity.nisha.com.popularmoviestage2.ui.fragments.MainActivityFragment;
...
public class MainActivity extends AppCompatActivity implements MainActivityFragment.OnGridViewSelectedListener {
    ...
    public void onGridItemSelected(MovieDetails movieDetails) {
        ...
        if (mTwoPane) {
            ...
            MovieDetailActivityFragment detailActivityFragment = MovieDetailActivityFragment.newInstance(movieDetails);
